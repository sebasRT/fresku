...
const BRANDS = ['Colanta'] as const;
const subcategoriesValues = Object.values(subcategories).flat();
const stockStatus = ["out", "low", "in"] as const;
...
export {
    ...
    stockStatus,
    subcategories,
    subcategoriesValues, type Category, type Subcategory
};
